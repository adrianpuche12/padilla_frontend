...
function ProviderForm({ provider, onSubmit, onClose, isLoading, error }) {
  ...
  useEffect(() => {
    if (provider) {
      setForm({
        ...
        personaType: provider.personaType || 'FISICA',
        ...
        ivaCondition: provider.ivaCondition || '',
  ...
  const handleSubmit = (e) => {
    ...
    const payload = isEditing
      ...
      : { ...form, specialty: form.specialty || null };
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="modal-form">
          ...
          {/* Datos del proveedor */}
          <div className="form-section-title">Datos del proveedor</div>
